...
function makePassword() {
    ...
    const Uppercasepresence = uppercaseCheckbox.checked;
    const Lowercasepresence = lowercaseCheckbox.checked;
    const Numberspresence = numbersCheckbox.checked;
    const Symbolspresence = symbolsCheckbox.checked;
...
function updateStrengthMeter(password) {
    ...
    // but this will make sure that "at maximum" we would get 40
...
function createRandomPassword(length, Uppercasepresence, Lowercasepresence, Numberspresence, Symbolspresence) {
    ...
    if (Numberspresence) allCharacters += numberCharacters;
